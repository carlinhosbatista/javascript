function leapY() {
    ...
    if ((year % 4 == 0) && (year % 100 != 0) || (year % 100 == 0)) {
        leapYear = `<mark style = "background-color: lightgreen; color: green;"> É BISSEXTO</mark> \u{2705}`
    } else {
        leapYear = `<mark style = "background-color: #f18f8f; color: darkred;"> NÃO É BISSEXTO</mark> \u{274C}`
    }
